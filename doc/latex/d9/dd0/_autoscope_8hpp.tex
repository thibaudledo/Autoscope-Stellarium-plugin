\hypertarget{_autoscope_8hpp}{}\section{Autoscope.\+hpp File Reference}
\label{_autoscope_8hpp}\index{Autoscope.hpp@{Autoscope.hpp}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{d7/da6/_autoscope_8hpp__incl}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{d9/dc5/_autoscope_8hpp__dep__incl}
\end{center}
\end{figure}
\subsection*{Classes}
...
\begin{DoxyCompactList}\small\item\em This class is use to retreive and compute data for sending to the telescope, and call user interfaces windows. \end{DoxyCompactList}\item 
