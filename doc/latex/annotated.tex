...
\item\contentsline{section}{\mbox{\hyperlink{class_autoscope}{Autoscope}} \\*This class is use to retrieve and compute data for sending to the telescope, and call user interfaces windows }{\pageref{class_autoscope}}{}
